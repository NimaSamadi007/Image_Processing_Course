...
def updateTexture(syn_tex, tex, M_p, N_p, M_i, N_i, x_s, x_f, y_s, y_f, x_thr, y_thr, rand_sel, hole_indices):
...
# ------------------------ MAIN ------------------------------- #
img = cv2.imread("im03-hole.jpg", cv2.IMREAD_COLOR)
